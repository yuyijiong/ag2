...
- [AutoGenBench](/docs/blog/2024-01-25-AutoGenBench/index). AutoGenBench is a commandline tool for downloading, configuring, running an agentic benchmark, and reporting results. It is designed to allow repetition, isolation and instrumentation, leveraging the new [runtime logging](/docs/use-cases/notebooks/notebooks/agentchat_logging) feature.
...
- new features like [stateful code execution](/docs/user-guide/advanced-concepts/code-execution), [tool decorators](/docs/user-guide/advanced-concepts/tools/), [long context handling](/docs/use-cases/notebooks/notebooks/agentchat_transform_messages), [web agents](/docs/user-guide/reference-agents/websurferagent).
